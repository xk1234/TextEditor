...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			BasicDocument bd = new BasicDocument(toTest);
			bd.getFleschScore();
			long currTime = System.nanoTime();
			double estTime = (currTime - startTime) / 100000000.0;
			System.out.print(estTime + ",");
			long startTime2 = System.nanoTime();
			EfficientDocument ed = new EfficientDocument(toTest);
			ed.getFleschScore();
			long currTime2 = System.nanoTime();
			double estTime2 = (currTime2 - startTime2) / 100000000.0;
